...
function mudarStyleLetra(tecla, condicao){
    if(condicao == false)
    {
        document.getElementById(tecla).style.background = "#f10c49";
        document.getElementById(tecla).style.color = "#ffffff";
    }
    else{
        document.getElementById(tecla).style.background = "#339194";
        document.getElementById(tecla).style.color = "#ffffff";
    }
...
function carregaImagemForca(){
    switch(tentativas){
        case 5:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca01.png')";
            break;
        case 4:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca02.png')";
            break;
        case 3:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca03.png')";
            break;
        case 2:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca04.png')";
            break;
        case 1:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca05.png')";
            break;
        case 0:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca06.png')";
            break;
        default:
            document.getElementById("imagem").style.background  = "url('./images/forca/forca.png')";
            break;
    }
}
